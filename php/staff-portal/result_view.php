...
?>
                ...
                <body id="page-top">
                    ...
                    <div id="wrapper">
                     ...
                     module_result.module_id AS MID
                     FROM 
                         module_result 
                     JOIN 
                         exam_result ON module_result.exam_id=exam_result.exam_id 
                         ...
                         module_result.exam_id = $userId";
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="p-3">
                                                                        <strong><?php echo $row2['module']; ?></strong>
                                                                    </div>
                                                                </td>
                                                                <td class="text-primary">
                                                                    <div class="p-3">
                                                                        <strong><?php if ($row2['marks'] < 40) { ?>
                                                                                <span class="text-danger"><b> <?php echo $row2["marks"] ?></b></span>
                                                                            <?php } elseif ($row2['marks'] >= 40 && $row2['marks'] < 60) { ?>
                                                                                <span class="text-warning"><b> <?php echo $row2["marks"] ?></b></span>
                                                                            <?php } elseif ($row2['marks'] >= 60 && $row2['marks'] < 70) { ?>
                                                                                <span class="text-success"><b> <?php echo $row2["marks"] ?></b></span>
                                                                            <?php } elseif ($row2['marks'] >= 70 && $row2['marks'] < 80) { ?>
                                                                                <span class="text-info"><b> <?php echo $row2["marks"] ?></b></span>
                                                                            <?php  } elseif ($row2['marks'] >= 80 && $row2['marks'] <= 100) { ?>
                                                                                <span class="text-primary"><b> <?php echo $row2["marks"] ?></b></span>
                                                                            <?php } ?>
                                                                        </strong>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="p-3">
                                                                        <button class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#UpdateModal" data-user-id="<?php echo $row2['MID']; ?>">Edit</button>
                                                                        <a type="button" class="btn btn-outline-danger" href="delete_module.php?deleteid=<?php echo $row2['MID']; ?>&examid=<?php echo $row2['EID']; ?>">
                                                                            Delete
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                ...
                                                <a href="result_add.php?editid=<?php echo $userId; ?>" type="button" class="btn btn-lg btn-primary p-3 m-3" style="float:right">Add</a>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="editUser" action="result_update.php">
                                        <div class="mb-3">
                                        ...
                                        <button class="btn btn-success" style="float:right" type="submit" name="added">Submit</button>
                                    </form>
                                </div>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            document.querySelectorAll('[data-bs-target="#UpdateModal"]').forEach(function(button) {
                                button.addEventListener('click', function() {
                                    ...
                                    fetch('fetchResultData.php?id=' + ModuleId + '&exam_id=' +
                                            <?php echo $userId ?>)
                                        .then(response => response.json())
                                        .then(data => {
                                            modalTitle.textContent = 'Editing Mark on ' + data.module_name;
                                            form.name.value = data.module_name;
                                            form.mark.value = data.marks;
...
<?php
            ...
            echo "<script>
    if (confirm('NO DATA HAS BEEN FOUND..... Do you want to add new data?')) {
        window.location.href = 'result_add.php?editid=$userId';
    } else {
        window.location.href = 'student_result.php';
    }
</script>";
        }
    } else {
