...
?>
    ...
    <head>
        ...
        <title>Staff Profile | University of Sam</title>
    ...
    <body id="page-top">
        ...
        if (isset($_POST['changepassword'])) {
            if ($oldpass == "" && $passwordErr  == "") {
                ...
                $UpdateQuery = "UPDATE staff SET password='$updatedpass' WHERE staff_id='" . $row['staff_id'] . "'";
                            ...
                            <div class="panel-body inf-content">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        fwrite($file, $power);
                                        fclose($file);
                                        echo "  <img class='img-profile rounded-circle mb-2 p-3'  src='./img/$photo_name' width='350px' height='350px' alt='Profile Picture from database'>";
                                        ?>
                                        <h2 class="text-center text-primary"> <?php
                                                                                if ($row['role'] == 0) {
                                                                                    echo '<span class="badge bg-success border">Staff</span>';
                                                                                } elseif ($row['role'] == 1) {
                                                                                    echo '<span class="badge bg-danger border">Manager</span>';
                                                                                } elseif ($row['role'] == 2) {
                                                                                    echo '<span class="badge bg-warning border">CEO</span>';
                                                                                } ?></h2>
                                    </div>
                                    <div class="col-md-6 mt-3 mb-3">
                                        ...
                                        <a href="profile_edit.php?editid=<?php echo $row['staff_id']; ?>" type="button" class="btn btn-lg btn-primary p-3 m-3" style="float:right">Edit Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
