...
?>
    ...
    <head>
        ...
        <title>Student Portal | University of Sam</title>
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div id="portal">
                        <div class="portal">
                            <h1 class="glowIn">&#x1F44B; Hello <?= $row['student_name']; ?>&#x1F44B;</h1>
                            <h2 class="glowIn">Welcome to the UOS's Student Portal &#127979;</h2>
                            <p class="glowIn"> Explore your profile &#128129;, access exam results &#128187;, and enjoy interactive activities and games &#127918;.</p>
